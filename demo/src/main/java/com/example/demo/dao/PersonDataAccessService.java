...
public class PersonDataAccessService implements PersonDao{
	...
	public int insertPerson(UUID id, Person person) {
		final String sqlquery = "INSERT INTO person (id, name) VALUES (?, ?)";
		return jdbcTemplate.update(sqlquery, id, person.getName());
	}
	...
	public int updatePersonById(UUID id, Person person) {
		final String sqlquery = "UPDATE person SET name = ? WHERE id = ?";
		return jdbcTemplate.update(sqlquery, person.getName(), id);
	}
